...
export default {
    ...
    methods: {
        ...
        async deletePh(phId) {
            try {
                var response = await this.$axios.delete(`/users/${this.receivedata.User}/media/${phId}/`);
